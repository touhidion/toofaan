...
const products = [
    ...
    },
    {
        ...
        rating: 4.6,
        reviews: 89,
        merchant: "Gadget Hub BD",
        verified: true,
        badge: "New",
        image: "https://images.unsplash.com/photo-1508685096489-7aac29145fe0?w=500&h=500&fit=crop"
    },
    {
        id: 13,
    ...
    },
    {
        ...
        rating: 4.8,
        reviews: 67,
        merchant: "Home Decor BD",
        verified: true,
        badge: "Eco",
        image: "https://images.unsplash.com/photo-1507473885765-e6ed605ad427?w=500&h=500&fit=crop"
    },
    {
        id: 16,
        name: "Ceramic Coffee Mug Set",
        ...
        verified: true,
        badge: "Duo",
        image: "https://images.unsplash.com/photo-1514228742587-6b1558fbed39?w=500&h=500&fit=crop"
    },
    {
        id: 17,
...
function renderCategorySections() {
    ...
    categoryConfigs.forEach(config => {
        const filteredProducts = products.filter(p => {
            ...
            if (config.id === 'fashion') return p.name.toLowerCase().includes('shirt') || p.name.toLowerCase().includes('backpack') || p.name.toLowerCase().includes('shoes') || p.name.toLowerCase().includes('sneakers');
